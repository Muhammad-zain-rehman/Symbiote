...
<Image
        ...
        <div className='mt-10 space-y-5'>
          ...
          <div className='mx-auto flex justify-center lg:sm-container'>
            <div className='py-10 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10'>
              ...
              <ServicesCard item={ARR[1]} custom_class={"h-[250px] xl:h-[170px] bg-primary text-accent"} />
              ...
              <div className='flex flex-col space-y-10 lg:space-y-6 mt-24 xl:mt-0'>
                <ServicesCard item={ARR[4]} custom_class={"h-[250px] xl:h-[160px] bg-primary text-accent -mt-[94px]"} />
                <ServicesCard item={ARR[5]} custom_class={"h-[250px]  xl:h-[160px] bg-primary text-accent"} />
      ...
      <div className=' h-[400px] lg:h-[350px] flex flex-col  justify-center items-center bg-cover bg-no-repeat text-accent bg-primary'
        style={{
