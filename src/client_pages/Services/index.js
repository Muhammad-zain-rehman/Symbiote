...
const Services = () => {
    return (
        <>
            ...
            <motion.div {...UP_ANIMATION}  className='py-20 container'>
            ...
            <motion.div {...UP_ANIMATION}  className=' bg-secondary min-h-[500px]  flex flex-col justify-center items-center'>
            ...
            <motion.div {...UP_ANIMATION}  className='py-12 md:py-24 space-y-8 md:space-y-14'>
